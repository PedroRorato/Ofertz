@extends('layouts.app')
@section('title') Login Empresa @endsection
@section('button') #nav-login @endsection
@section('content')
<div class="container">
    <div class="row ">
        <form class="py-5 col-lg-6 col-md-8 mx-auto" method="POST" action="/empresa/login">
            <h2 class="text-center pb-2">Login Empresa</h2>
            @csrf
            ...
            <a href="/empresa/cadastro" class="btn btn-dark btn-block">Cadastrar</a>
        </form> 
    </div>
</div>
@endsection