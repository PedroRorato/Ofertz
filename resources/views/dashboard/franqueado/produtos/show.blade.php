...
<li class="breadcrumb-item"><a href="/franqueado/produtos/{{ $produto->id }}">Painel do Produto</a></li>
@endsection
@section('content')
...
<form method="POST" action="/franqueado/produtos/{{ $produto->id }}" enctype="multipart/form-data"  onsubmit="progressBar()">
