...
<body class="dash-body">
    <div id="menu" class="bg-dark px-0">
        <div id="menu-scroll" class="pb-1">
                ...
                <div class="card card-menu-profile">
                    ...
                    <div id="collapseProfile" class="collapse" aria-labelledby="headingThree" data-parent="#menu-accordion">
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link" href="/franqueado/conta">
            ...
            <!-- END PROFILE -->
            <!-- MENU -->
            <a href="/franqueado" id="inicial-menu" class="btn btn-block btn-menu"><i class="fas fa-home mr-2"></i>Inicial</a>
            <a href="/franqueado/empresas" id="empresas-menu" class="btn btn-block btn-menu"><i class="fas fa-store mr-2"></i>Empresas</a>
            <a href="/franqueado/eventos" id="eventos-menu" class="btn btn-block btn-menu"><i class="fas fa-glass-cheers mr-2"></i>Eventos</a>
            <a href="/franqueado/ofertas" id="ofertas-menu" class="btn btn-block btn-menu"><i class="fas fa-tag mr-2"></i>Ofertas</a>
            <a href="/franqueado/produtos" id="produtos-menu" class="btn btn-block btn-menu"><i class="fas fa-gifts mr-2"></i>Produtos</a>
            <a href="/franqueado/usuarios" id="usuarios-menu" class="btn btn-block btn-menu"><i class="fas fa-users mr-2"></i>Usuários</a>
            <!-- END MENU -->            
        </div>
        <!-- COPYRIGHT -->
