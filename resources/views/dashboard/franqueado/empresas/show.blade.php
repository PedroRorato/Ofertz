...
<li class="breadcrumb-item"><a href="/franqueado/empresas/{{ $empresa->id }}">Painel da Empresa</a></li>
@endsection
@section('content')
...
@endif
<a href="/franqueado/empresas" class="btn btn-secondary shadow mb-3"><i class="fas fa-arrow-left mr-2"></i>Voltar</a>
<form method="POST" action="/franqueado/empresas/{{ $empresa->id }}" enctype="multipart/form-data" onsubmit="progressBar()">
