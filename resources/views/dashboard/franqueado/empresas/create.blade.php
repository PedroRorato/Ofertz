...
<li class="breadcrumb-item"><a href="/franqueado/empresas/create">Adicionar</a></li>
@endsection
@section('content')
...
<form method="POST" action="/franqueado/empresas" enctype="multipart/form-data" onsubmit="progressBar()">
