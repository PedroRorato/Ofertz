...
@section('breadcrumbs') 
<li class="breadcrumb-item"><a href="/empresa/conta">Meus Dados</a></li>
@endsection
@section('content')
...
<a href="/empresa/empresas" class="btn btn-secondary shadow mb-3"><i class="fas fa-arrow-left mr-2"></i>Voltar</a>
<form method="POST" action="/empresa/conta" enctype="multipart/form-data" onsubmit="progressBar()">
...
<div class="modal fade" id="modalSenha" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="/empresa/conta">
                @csrf
                @method('PATCH')
