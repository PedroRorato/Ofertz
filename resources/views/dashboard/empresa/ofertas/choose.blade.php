...
<li class="breadcrumb-item"><a href="/empresa/ofertas/choose">Escolher Produto</a></li>
@endsection
@section('content')
...
<a href="/empresa/ofertas" class="btn btn-secondary shadow mb-3"><i class="fas fa-arrow-left mr-2"></i>Voltar</a>
<div class="card shadow">
    <div class="card-body">
        <h4><i class="fas fa-filter mr-2"></i>Filtros</h4>        
        <form method="GET" action="/empresa/ofertas/choose">
            <div class="row">
            ...
            <a href="/empresa/ofertas/choose" class="btn btn-secondary shadow mr-3"><i class="fas fa-sync-alt mr-2"></i>Limpar filtros</a>
        </form>
        <hr>
        @if($amount != 0)
                ...
                <tbody>
                    @foreach($produtos as $produto)
                        <tr>
                            ...
                            <td>{{ $produto->enome }}</td>
                            <td>
                                <a href="/empresa/ofertas/produto/{{ $produto->id }}/create" class="btn btn-primary shadow" data-toggle="tooltip" title="Criar nova oferta">
