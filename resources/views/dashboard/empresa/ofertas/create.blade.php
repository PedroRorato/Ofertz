...
<li class="breadcrumb-item"><a href="/empresa/ofertas/produto/{{ $produto->id }}/create">Adicionar Oferta</a></li>
@endsection
@section('content')
...
<a href="/empresa/ofertas/choose" class="btn btn-secondary shadow mb-3"><i class="fas fa-arrow-left mr-2"></i>Voltar</a>
<div class="card shadow">
    <div class="card-body">
        <form method="POST" action="/empresa/ofertas">
            @csrf
