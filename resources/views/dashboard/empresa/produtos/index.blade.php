...
@endsection
@section('content')
<a href="/empresa/produtos/create" class="btn btn-primary shadow mb-3"><i class="fas fa-plus mr-2"></i>Adicionar</a>
<div class="card shadow">
    <div class="card-body">
        <h4><i class="fas fa-filter mr-2"></i>Filtros</h4>        
        <form method="GET" action="/empresa/produtos">
            ...
            <a href="/empresa/produtos" class="btn btn-secondary shadow mr-3"><i class="fas fa-sync-alt mr-2"></i>Limpar filtros</a>
        </form>
        <hr>
        @if($amount != 0)
            ...
            <table class="table mb-0" >
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $produto->nome }}</td>
                        <td>
                            <a href="/empresa/produtos/{{ $produto->id }}" class="btn btn-primary shadow" data-toggle="tooltip" title="Editar">
