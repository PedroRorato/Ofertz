...
<li class="breadcrumb-item"><a href="/empresa/produtos/create">Adicionar</a></li>
@endsection
@section('content')
...
<form method="POST" action="/empresa/produtos" enctype="multipart/form-data" onsubmit="progressBar()">
