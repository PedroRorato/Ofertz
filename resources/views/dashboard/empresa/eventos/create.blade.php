...
<li class="breadcrumb-item"><a href="/empresa/eventos/create">Adicionar</a></li>
@endsection
@section('content')
...
<a href="/empresa/eventos" class="btn btn-secondary shadow mb-3"><i class="fas fa-arrow-left mr-2"></i>Voltar</a>
<form method="POST" action="/empresa/eventos" enctype="multipart/form-data" onsubmit="progressBar()">
