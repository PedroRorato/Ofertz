...
<li class="breadcrumb-item"><a href="/franqueado/eventos/{{ $evento->id }}">Painel do Evento</a></li>
@endsection
@section('content')
...
@if ($editar)
<form method="POST" action="/franqueado/eventos/{{ $evento->id }}" enctype="multipart/form-data"  onsubmit="progressBar()">
<div class="card shadow">
    <div class="card-body">
        @csrf
        @method('PATCH')
        <h5>Realizado por: {{ $evento->empresa->empresa }}</h5>
