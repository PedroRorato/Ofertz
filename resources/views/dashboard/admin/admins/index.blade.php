...
<a href="/admin/admins/create" class="btn btn-primary shadow mb-3"><i class="fas fa-plus mr-2"></i>Adicionar Administrador</a>
        ...
        <form method="GET" action="/admin/admins">
            <div class="row">
                <div class="form-group col-md-9">
                    <label for="name">Digite um nome, sobrenome ou email</label>
                    <input type="text" class="form-control" id="name" name="busca" placeholder="Buscar..." value="{{ isset($queries['busca']) ? $queries['busca'] : '' }}">
                </div>
