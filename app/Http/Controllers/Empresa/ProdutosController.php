...
class ProdutosController extends Controller
{
    ...
    public function index(Request $request){
        ...
        $queries = [];
        //Cidade Específica
        $produtos = $produtos->where('empresa_id', '=', Auth::user()->id)->where('status', '!=', 'EXCLUIDO');
        //Queries
        ...
        return view('dashboard.empresa.produtos.index', compact('produtos', 'amount', 'queries'));
    }
    ...
    public function create(){
        ...
        return view('dashboard.empresa.produtos.create', compact('categorias'));
    }
    ...
    public function store(Request $request){
        ...
        ////Return
        return redirect('/empresa/produtos')->withMessage("Produto criado com sucesso!");
    }
    ...
    public function show($id){
        ...
        //Lista de categorias
        $categorias = CategoriasProduto::where('status', '=', 'ATIVO')->orderBy('nome', 'asc')->get();
        return view('dashboard.empresa.produtos.show', compact('produto', 'pertences', 'categorias'));
    }
    ...
    public function update(Request $request, $id){
        ...
        //Redirect
        return redirect('/empresa/produtos/'.$id)->withMessage("Edição realizada com sucesso!");
    }
    ...
    public function destroy($id){
        ...
        //Redirect
        return redirect('/empresa/produtos')->withMessage("Produto excluído com sucesso!");
